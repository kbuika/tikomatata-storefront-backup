...
export default function Custom404() {
  return (
    <div className="h-screen w-screen bg-gray-100 flex items-center">
      <Head>
        <title>Tikomatata | You seem to be lost</title>
      </Head>
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div className="max-w-md">
          ...
          <Link href="/">
            <button className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded bg-mainPrimary active:bg-mainPrimary hover:bg-mainPrimary/700">
              back to homepage
            </button>
          </Link>
        </div>
        <div className="max-w-lg">
          ...
          >
            ...
            />
            <path
              className="cls-5 bg-mainPrimary"
